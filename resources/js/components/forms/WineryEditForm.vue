...
<script>
    export default {
        ...
        methods: {
            ...
            getProfilePhoto() {
                return this.wineryProfile?`/storage/images/wineries/profile/${this.wineryProfile}`:this.defaultProfilePhoto;
            },
            getCoverPhoto() {
                return this.wineryCover?`/storage/images/wineries/cover/${this.wineryCover}`:this.defaultCoverPhoto;
            }
        }
    }
</script>
