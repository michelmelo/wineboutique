    ...
    <div>
        ...
        <form action="/preregister" class="form-inline" method="post" v-on:submit="onSubmit" enctype="multipart/form-data" id="captcha-form">
                ...
                <span class="help-block error-block" v-if="isInvalid('firstName')">
                    ...
                    <input :class="{ 'invalid': isInvalid('lastName') }" name="lastName" placeholder="Last Name" type="text"
                           v-model.trim="lastName">
                <span class="help-block error-block" v-if="isInvalid('lastName')">
                    <strong>Last Name is required.</strong>
                </span>
                <input :class="{ 'invalid': isInvalid('companyName') }" name="companyName" placeholder="Company Name"
                       type="text" v-model.trim="companyName">
                <span class="help-block error-block" v-if="isInvalid('companyName')">
                    <strong>Company Name is required.</strong>
                </span>
                <input :class="{ 'invalid': isInvalid('email') || validEmail===false, 'valid': validEmail }" name="email"
                ...
                <input :class="{ 'invalid': isInvalid('phone') }" name="phone" placeholder="Phone number" type="text"
                       v-model.trim="phone">
                <span class="help-block error-block" v-if="isInvalid('phone')">
                    <strong>Phone number is invalid.</strong>
                </span>
                <input :class="{ 'invalid': isInvalid('job') }" name="job" placeholder="Job title" type="text"
                       v-model.trim="job">
                <span class="help-block error-block" v-if="isInvalid('job')">
                    <strong>Please enter your job title.</strong>
                </span>

                <input :class="{ 'invalid': isInvalid('brands') }" name="brands" placeholder="Number of brands" type="number" min="1"
                       v-model.trim="brands">
                <span class="help-block error-block" v-if="isInvalid('brands')">
                    <strong>Number of brands must be a positive number.</strong>
                </span>

                <input name="licences" placeholder="Number of brands" type="file" accept=".pdf, .jpg, .jpeg, .png"
                       v-on:change="licenceAdded">
                ...
                <div class="form-check">
                    <input class="form-check-input" id="defaultCheck1" name="acceptTerms" type="checkbox"
                           v-model="acceptTerms">
                    <label :class="{ 'invalid': isInvalid('acceptTerms') }" class="form-check-label" for="defaultCheck1">
                        I agree to <a @click="activePopup = !activePopup" href="#">Terms and Conditions.</a> of the Wine
                        Boutique*
                    </label>
                </div>
        ...
        <transition name="fade">
            <div class="terms-popup is-visible" role="alert" v-if="activePopup">
                <div class="popup-container">
                    <a @click="activePopup = !activePopup" class="popup-close img-replace" href="#0">Close</a>
                    ...
                    <div class="popup-body">
                        <div class="mb-4">
                            <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before
                                using the https://wineboutique.com website (the "Service") operated by Wine Boutique
                                Technologies LLC ("us", "we", or "our").Your access to and use of the Service is
                                conditioned upon your acceptance of and compliance with these Terms. These Terms apply
                                to all visitors, users and others who wish to access or use the Service.By accessing or
                                using the Service you agree to be bound by these Terms. If you disagree with any part of
                                the terms then you do not have permission to access the Service.</p>
                            ...
                            <p>If you wish to purchase any product or service made available through the Service
                                ...
                                warrant that: (i) you havethe legal right to use any credit card(s) or other payment
                                method(s) in connection with any Purchase; and that (ii) the information you supply to
                                us is true, correct and complete.The service may employ the use of third party services
                                for the purpose of facilitating payment and the completion of Purchases. By submitting
                                ...
                                order at any time forreasons including but not limited to: product or service
                                availability, errors in the description or price of the product or service, error in
                                your order or other reasons.We reserve the right to refuse or cancel your order if fraud
                                or an unauthorized or illegal transaction is suspected.</p>

                            <h3 class="text-center">Availability, Errors and Inaccuracies</h3>
                            <p>We are constantly updating product and service offerings on the Service. We may
                            ...
                            <p>Any contests, sweepstakes or other promotions (collectively, "Promotions") made available
                                ...
                                Conditions. If you participate in any Promotions, please review the applicable rules as
                                well as our Privacy Policy. If the rules for a Promotion conflict with these Terms and
                                Conditions, the Promotion rules will apply.</p>

                            <h3 class="text-center">Accounts</h3>
                            <p>When you create an account with us, you guarantee that you are above the age of 18, and
                                ...
                                of your account on the Service.You are responsible for maintaining the confidentiality
                                of your account and password, including but not limited to the restriction of access to
                                ...
                                upon becoming aware of any breach of security or unauthorized use of your account.We
                                reserve the right to refuse service, terminate accounts, remove or edit content, or
                                cancel orders in our sole discretion.</p>
                            ...
                            <p>We respect the intellectual property rights of others. It is our policy to respond to any
                                ...
                                intellectual property rights ("Infringement") of any person or entity.If you are a
                                copyright owner, or authorized on behalf of one, and you believe that the copyrighted
                                work has been copied in a way that constitutes copyright infringement, please submit
                                your claim via email to dmca@wineboutique.com, with the subject line: "Copyright
                                ...
                                Infringement Claims"You may be held accountable for damages (including costs and
                                attorneys' fees) for misrepresentation or bad-faith claims on the infringement of any
                                Content found on and/or through the Service on your copyright.</p>
                            ...
                            <ul>
                                ...
                                <li>a description of the copyrighted work that you claim has been infringed, including
                            ...
                            <p>The Service and its original content, features and functionality are and will remain the
                                exclusive property of Wine Boutique Technologies LLC and its licensors. The Service is
                                protected by copyright, trademark, and otherlaws of both the United States and foreign
                                countries. Our trademarks and trade dress may not be used in connection with any product
                                or service without the prior written consent of Wine Boutique Technologies LLC.</p>
                            ...
                            <p>Our Service may contain links to third party web sites or services that are not owned or
                                controlled by Wine Boutique Technologies LLCWine Boutique Technologies LLC has no
                                control over, and assumes no responsibility for the content, privacy policies, or
                                practices of any third party web sites or services. We do not warrant the offerings of
                                any of these entities/individuals or their websites.You acknowledge and agree that Wine
                                Boutique Technologies LLC shall not be responsible or liable, directly or indirectly,
                                for any damageor loss caused or alleged to be caused by or in connection with use of or
                                reliance on any such content, goods or services available on or through any such third
                                party web sites or services.We strongly advise you to read the terms and conditions and
                            ...
                            <p>We may terminate or suspend your account and bar access to the Service immediately,
                                ...
                                andwithout limitation, including but not limited to a breach of the Terms.
                            ...
                            <p>You agree to defend, indemnify and hold harmless Wine Boutique Technologies LLC and its
                                ...
                                resulting from or arising out of a) your use and access of the Service, by you or any
                            ...
                            <p>Your use of the Service is at your sole risk. The Service is provided on an "AS IS" and
                                ...
                                Wine Boutique Technologies LLC its subsidiaries, affiliates, and its licensors do not
                            ...
                            <p>Some jurisdictions do not allow the exclusion of certain warranties or the exclusion or
                                ...
                                above may not apply to you.</p>

                            <h3 class="text-center">Governing Law</h3>
                            <p>These Terms shall be governed and construed in accordance with the laws of Florida,
                                United States, withoutregard to its conflict of law provisions.
                            ...
                            <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any
                                ...
                                terms, you are no longer authorized to use the Service.</p>

                            <h3 class="text-center">Contact Us</h3>
                            <p>If you have any questions about these Terms, please contact us.</p>
                        </div>
                        <div class="text-center py-4">
                            <span @click="acceptTermsFn" class="button red-button" href="#0"><i
                                    class="fas fa-check"></i> ACCEPT</span>
                            <span @click="activePopup = !activePopup" class="button red-button" href="#0"><i
                                    class="fas fa-times"></i> CLOSE</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            licenceAdded(event) {
                this.licences = event.target.files[0] !== 'undefined';
            },
            acceptTermsFn() {
