...
<div class="container">
    <!-- @php
        var_dump($errors);
    @endphp -->
    <form method="POST" action="{{ route('add-new-wine.update', ['wine' => $wine->id]) }}" class="row padding-row add-new-wine" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div>
                <div class="row form-inputs">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <input type="text" name="name" id="name" placeholder="Title name" value="{{ old('name') ? old('name') : $wine->name }}" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" required>
                        @if($errors->has('name'))
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <input type="text" id="who_made_it" name="who_made_it" placeholder="Who made it?" value="{{ old('who_made_it') ? old('who_made_it') : $wine->who_made_it }}" class="form-control{{ $errors->has('who-made-it') ? ' is-invalid' : '' }}" required>
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <select id="when_was_it_made" name="when_was_it_made" value="{{ old('when_was_it_made') ? old('when_was_it_made') : $wine->when_was_it_made }}" class="form-control{{ $errors->has('when-was-it-made') ? ' is-invalid' : '' }}">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <select name="varietal" id="varietal" class="form-control{{ $errors->has('varietal') ? ' is-invalid' : '' }}">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <input type="number" min="0" name="capacity" id="capacity" placeholder="Enter a number" value="{{ old('capacity') ? old('capacity') : $wine->capacity }}" class="form-control{{ $errors->has('capacity') ? ' is-invalid' : '' }}" required>
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <select name="unit_id" id="unit_id" value="{{ old('unit_id') ? old('unit_id') : $wine->unit_id }}" class="form-control{{ $errors->has('unit_id') ? ' is-invalid' : '' }}">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <textarea id="description" type="text" name="description" placeholder="Add text" value="{{ old('description') ? old('description') : $wine->description }}" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"></textarea>
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <input data-role="tagsinput" type="text" name="tags" placeholder="Tag1, tag2, tag3, etc." value="{{ old('tags') ? old('tags') : $wine->tags }}" class="form-control{{ $errors->has('tags') ? ' is-invalid' : '' }}">
                        @if($errors->has('tags'))
                            <span class="help-block">
            ...
            <div class="col-lg-6 col-sm-12">
                <div>
                    <div class="row form-inputs">
                        ...
                        <div class="col-lg-8 col-sm-12">
                            <input type="number" min="0" name="price" class="usd-input" value="{{ old('price') ? old('price') : $wine->price }}" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" required>
