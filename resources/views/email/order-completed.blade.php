                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px 15px 0;background-color: #fff;">
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #000000; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        	Your Order <strong>{{ $order }}</strong> has been despatched. Please expect to receive your items within <strong>[Number of Days that Winery entered]</strong> days.
                                        </p>
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #000000; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        	Your tracking number is <strong>[TRACKING NUMBER WINERY ENTERS]</strong>, so please keep this email in your inbox for reference.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
