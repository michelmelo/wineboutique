                    ...
                    <div class="carousel-inner preview-pic">
                        ...
                        @foreach($wine_images as $img)
                            <div class="carousel-item" data-slide-number="{{$loop->iteration}}">
                                <div class="carousel-image">
                                    <img src="{{ route('images.wine', ['slug' => $img->slug . '.jpg']) }}"
                                         class="img-fluid">
                                </div>
                            </div>
                        @endforeach
                    ...
                    <ul class="carousel-indicators list-inline mx-auto px-2 mt-3 w-100">
                        ...
                        @foreach($wine_images as $img)
                            <li class="list-inline-item">
                                <a id="carousel-selector-{{$loop->iteration}}" data-slide-to="{{$loop->iteration}}"
                                   data-target="#wineCarousel">
                                    <img src="{{ route('images.wine', ['slug' => $img->slug . '.jpg']) }}"
                                         class="img-fluid">
                                </a>
                            </li>
            ...
            <div class="col-lg-6 col-sm-12 single-wine-info">
                ...
                <div class="row">
                    <div class="col-4 center-text">
                        <p>
                            SHIPPING</p> <?php $price = number_format($wine->winery->winery_shippings->min('price'), 2, '.', ',') ?>
                    ...
                    <div class="col-4 center-text">
                        <p>RATING</p>
                        <rating :post="'{{ $wine->slug }}'" :rating="{{$wine->rating()}}"
                                :readonly="{{ Auth::check()&&Auth::user()->type!=='SELLER' ? 'false' : 'true' }}"
                                :type="'wine'"></rating>
                    </div>
                </div>
        ...
        <div class="row padding-row">
            <div class="wine-description">
                <ul class="nav nav-tabs row">
                    <li class="cat-tab active col-6 center-text pr-0"><a data-toggle="tab" href="#description"
                                                                         class="active">DESCRIPTION</a></li>
                    <li class="cat-tab active col-6 center-text pl-0"><a data-toggle="tab" href="#info">WINERY INFO</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div id="description" class="tab-pane fade in active show">
                        ...
                        <div class="shipping-regions">
                            <h2 class="my-5" style="color: #9C193A;">This wine is currently being shipped to these
                                states:</h2>
                            <ul>
